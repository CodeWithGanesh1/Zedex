...
const Cart = () => {
    ...
    // FIX: Destructured handleDecrementCartItem from the hook
    ...
    async function handleCheckout() {
        ...
        const options = {
            key: "rzp_test_T6YEClUfeE4sfM",//import.meta.env.VITE_RAZORPAY_KEY_ID,
                        ...
                        <div className="w-full lg:w-[65%]">
                            ...
                            <div className="flex flex-col gap-6">
                                {cart.items.map((item, index) => {
                                    const uniqueKey = item._id || `${item.product?._id}-${item.variant}`;
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 flex flex-col justify-between">
                                                ...
                                                <div className="flex items-center justify-between flex-wrap gap-4">
                                                    ...
                                                    >
                                                        {/* FIX: Changed handleIncrementCartItem to handleDecrementCartItem here */}
                                                        <button
                                                            id={`qty-dec-${uniqueKey}`}
                                                        ...
                                                        <button
                                                            id={`qty-inc-${uniqueKey}`}
                                                            onClick={() => handleIncrementCartItem({ productId: product?._id, variantId, count: 1 })}
                                                            className="w-9 h-9 flex items-center justify-center text-sm font-light transition-colors hover:opacity-60"
    ...
    id={`remove-${uniqueKey}`}
    onClick={() => {
        console.log("Removing Item IDs:", { productId: product?._id, variantId });
